#### GIS libraries are not globally installed 
```python
#!/Users/g_joss/opt/anaconda3/envs/the_geo_env/bin/python3.10
```
#### 
```python
import geopandas as gp  # Geo dataframe processing
import folium as fol  # interactive web making
from branca.colormap import linear # color selection
import pandas as pd # reading csv file
from geopy.geocoders import Nominatim # geo code look up for map starting point
```
